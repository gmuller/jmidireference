...
public enum NoteReference {
	...
	private static final Map<String,NoteReference> lookup 
    = new HashMap<String,NoteReference>();
	 ...
	 * As an example G has a base note number of 7.
	 * 
	 * @return the integer of the note at octave 0
	 */
	public int getBaseNumber() { return baseNumber; }
	String getBaseName() { return baseNoteName; }
	
	/**
	 * Reverse lookup of a NoteReference based on the abbreviation passed in.
	 * For example, passing in the String "C#" will return the Csharp NoteReference
	 * 
	 * @param baseName
