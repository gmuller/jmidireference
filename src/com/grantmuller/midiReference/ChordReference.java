package com.grantmuller.midiReference;
...
public enum ChordReference {
	...
	private static final Map<String,ChordReference> lookup 
    = new HashMap<String,ChordReference>();
	...
	private static final int[] 
					...
					DIMINISHED_SEVENTH_CHORD = {0, 3, 6, 9},
					HALF_DIMINISHED_SEVENTH_CHORD = {0, 3, 6, 10},
					...
					SUSPENDED_FOURTH_CHORD = {0, 5, 7},
					SUSPENDED_SECOND_CHORD = {0, 2, 7},
					SEVENTH_SUSPENDED_FOURTH_CHORD = {0, 5, 7, 10},
					SEVENTH_SUSPENDED_SECOND_CHORD = {0, 2, 7, 10},
					ADD_TWO_CHORD = {0, 2, 4, 7},
					ADD_NINE_CHORD = {0, 4, 7, 14},
					ADD_FOURTH_CHORD = {0, 4, 5, 7},
					SIXTH_CHORD = {0, 4, 7, 9},
					MINOR_SIXTH_CHORD = {0, 3, 7, 9},
					SIX_NINE_CHORD = {0, 4, 7, 9, 14},
					NINTH_CHORD = {0, 4, 7, 10, 14},
					MINOR_NINTH_CHORD = {0, 3, 7, 10, 14},
					MAJOR_NINTH_CHORD = {0, 4, 7, 11, 14},
					ELEVENTH_CHORD = {0, 4, 7, 10, 14, 17},
					MINOR_ELEVENTH_CHORD = {0, 3, 7, 10, 14, 17},
					MAJOR_ELEVENTH_CHORD = {0, 4, 7, 11, 14, 17},
					THIRTEENTH_CHORD = {0, 4, 7, 10, 14, 17, 21},
					MINOR_THIRTEENTH_CHORD = {0, 3, 7, 10, 14, 17, 21},
					MAJOR_THIRTEENTH_CHORD = {0, 4, 7, 11, 14, 17, 21},
					SEVENTH_SHARP_NINE_CHORD = {0, 4, 7, 10, 15},
					SEVENTH_FLAT_NINE_CHORD = {0, 4, 7, 10, 13},
					SEVENTH_SHARP_FIFTH_CHORD = {0, 4, 8, 10},
					SEVENTH_FLAT_FIFTH_CHORD = {0, 4, 6, 10};
	 ...
	 * For example a Major chord is made up of the root, the third and the fifth. Taking zero as the
	 * root, the third is 5 notes away, and the the fifth is 7 notes away. The integer array for 
	 * this chord would be {0, 5, 7}. 
	 * 
	...
	public int[] getDegrees(){
		switch (this){
			case MAJOR: return MAJOR_CHORD;
			case MINOR: return MINOR_CHORD;
			case DIMINISHED: return DIMINISHED_CHORD;
			case DIMISHED_SEVENTH: return DIMINISHED_SEVENTH_CHORD;
			case HALF_DIMINISHED: return HALF_DIMINISHED_SEVENTH_CHORD;
			case AUGMENTED: return AUGMENTED_CHORD;
			case FIFTH: return FIFTH_CHORD; 
			case SEVENTH: return SEVENTH_CHORD;
			case MINOR_SEVENTH: return MINOR_SEVENTH_CHORD;
			case MAJOR_SEVENTH: return MAJOR_SEVENTH_CHORD;
			case MINOR_MAJOR_SEVENTH: return MINOR_MAJOR_SEVENTH_CHORD;
			case SUSPENDED_FOURTH: return SUSPENDED_FOURTH_CHORD;
			case SUSPENDED_SECOND: return SUSPENDED_SECOND_CHORD;
			case SEVENTH_SUSPENDED_FOURTH: return SEVENTH_SUSPENDED_FOURTH_CHORD;
			case SEVENTH_SUSPENDED_SECOND: return SEVENTH_SUSPENDED_SECOND_CHORD;
			case ADD_TWO: return ADD_TWO_CHORD;
			case ADD_NINE: return ADD_NINE_CHORD;
			case ADD_FOURTH: return ADD_FOURTH_CHORD;
			case SIXTH: return SIXTH_CHORD;
			case MINOR_SIXTH: return MINOR_SIXTH_CHORD;
			case SIX_NINE: return SIX_NINE_CHORD;
			case NINTH: return NINTH_CHORD;
			case MINOR_NINTH: return MINOR_NINTH_CHORD;
			case MAJOR_NINTH: return MAJOR_NINTH_CHORD;
			case ELEVENTH: return ELEVENTH_CHORD;
			case MINOR_ELEVENTH: return MINOR_ELEVENTH_CHORD;
			case MAJOR_ELEVENTH: return MAJOR_ELEVENTH_CHORD;
			case THIRTEENTH: return THIRTEENTH_CHORD;
			case MINOR_THIRTEENTH: return MINOR_THIRTEENTH_CHORD;
			case MAJOR_THIRTEENTH: return MAJOR_THIRTEENTH_CHORD;
			case SEVENTH_SHARP_NINE: return SEVENTH_SHARP_NINE_CHORD; 
			case SEVENTH_FLAT_NINE: return SEVENTH_FLAT_NINE_CHORD;
			case SEVENTH_SHARP_FIFTH: return SEVENTH_SHARP_FIFTH_CHORD;
			case SEVENTH_FLAT_FIFTH: return SEVENTH_FLAT_FIFTH_CHORD;
		}
		throw new AssertionError("Unknown Scale: " + this);
	}
	
	/**
	 * Gets the abbreviated name of the chord. For example a Major Thirteenth chord
	 * is abbreviated maj13.
	 * 
	...
	/**
	 * Reverse lookup of the enum ChordReference by the abbreviation. Passing in "maj13" will
	 * return the MAJOR_THIRTEENTH ChordReference
	 * 
	 * @param commonName
